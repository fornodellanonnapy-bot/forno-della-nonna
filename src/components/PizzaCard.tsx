...
interface PizzaCardProps {
  ...
  onEdit?: (updated: PizzaItem) => void;
}

export function PizzaCard({ pizza, onAdd, onEdit }: PizzaCardProps) {
    ...
    <>
      <div 
        ...
        style={{
          ...
          overflow: 'hidden',
          border: isAdmin ? '1px solid rgba(255,94,0,0.4)' : '1px solid rgba(255, 94, 0, 0.15)',
        ...
        onMouseLeave={(e) => {
          ...
          e.currentTarget.style.borderColor = isAdmin ? 'rgba(255,94,0,0.4)' : 'rgba(255,255,255,0.05)';
        }}
      >
